...
import { milestones, categories, getMilestonesByYear } from '../data/milestones';
    ...
    <div className="card-gradient border border-gray-700/50 rounded-3xl p-8 mb-8">
      <div className="mb-8">
        <h2 className="text-4xl font-bold mb-4 text-gradient flex items-center gap-3">
          ...
          Bitcoin's Journey: Major Milestones
        </h2>
        <p className="text-gray-400 text-lg">
          Explore the pivotal moments that transformed Bitcoin from a whitepaper to a global financial asset.
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center mb-6">
                <div className="relative z-10 bg-bitcoin-orange text-black font-bold text-2xl px-6 py-2 rounded-full shadow-lg">
                  {year}
                </div>
